...
func (r *PGRepository) CreateDeployment(ctx context.Context, d *Deployment) error {
	_, err := r.db.Exec(ctx,
		`INSERT INTO deployments (id, model_id, org_id, name, status, sla_tier, deploy_mode, replicas_min, replicas_max,
		 ...
		 prefill_pipeline_parallel_size, decode_pipeline_parallel_size, search_strategy, frontend_replicas, worker_command,
		...
		d.PrefillPipelineParallelSize, d.DecodePipelineParallelSize, d.SearchStrategy, d.FrontendReplicas, d.WorkerCommand,
